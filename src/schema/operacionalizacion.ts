/**
 * Operacionalización de variables — Variable dependiente: Cultivos agrícolas
 * Fuente: matriz de tesis (dimensiones, indicadores, instrumentos).
 */
...
export type IndicadorOperacional = {
  ...
  unidad?: string;
  /** Módulo de la app que alimenta este indicador */
  fuenteApp?: string;
};
...
export function findIndicador(id: string): {
  dimension: DimensionOperacional;
