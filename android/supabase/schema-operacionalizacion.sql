-- Operacionalización de variables (tesis) — Variable dependiente: Cultivos agrícolas
...
comment on table public.indicadores_operacionalizacion is
  'Registros de indicadores de operacionalización — variable dependiente Cultivos agrícolas';
